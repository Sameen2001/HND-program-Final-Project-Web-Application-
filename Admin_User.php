...
if(isset($_GET['btnSearch']))
{
  ...
  $sql = "SELECT * FROM users WHERE (UName LIKE '$search' OR Type LIKE '$search')";
}
else
{
            ...
            <table class="table" style=" margin-top: -20px;">
              <thead class="thead-dark">
                <tr>
                    ...
                    <th class="collom2" scope="co1"> User iformation </th>  
                    <th class="collom3" scope="co1"> Type </th>              
                    <th class="collom4" scope="col"> Te_no </th>
                    <th class="collom5" scope="col"> Buttons </th>
              </thead>
              ...
              <tbody>
              <tr>
              <th scope="row"><div class="CId"><?php echo $row['Uid']; ?></div></th>

              <td>
                <div class="d-flex align-items-center">
                  <img src="<?php echo '../User/'.$image; ?>" style="width: 45px; height: 45px" class="rounded-circle"  data-holder-rendered="true"/>

                  <div class="ms-3" style="margin-left: 15px;">
                    <p class="fw-bold mb-1"><?php echo $row['UName']; ?></p>
                    <p class="text-muted mb-0"><?php echo $row['Email']; ?></p>
                  </div>
                </div>
              </td>

              <td><div class="description"><?php echo $row['Type']; ?></div> </td>
              <td><div class="description"><?php echo $row['Te_No']; ?></div> </td>
              <td>
                <div class="cbuttons" style="display: flex;">   
                  
                    <form action="#" method="get" style=" margin-left: 40px;">
                        <input type="hidden" id="Id" name="Id" Value="<?php echo $row['Uid']; ?>">                            
            ...
            <div class="modal-body">            
              ...
              <form action="#" method="post">
                  <div class="form-group">
                    ...
                    <center><h2> <b> Update User</b></h2></center><br/>  
